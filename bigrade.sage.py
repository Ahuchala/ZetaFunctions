...
_sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_17 = Integer(17); _sage_const_2 = Integer(2); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0)
import itertools
...
B = [R(_sage_const_1 ), x_2**_sage_const_3 *y_0]
...
P_1_mons = [x_0**_sage_const_3 *y_0, x_0**_sage_const_2 *x_1*y_0, x_0**_sage_const_2 *x_2*y_0, x_0*x_1**_sage_const_2 *y_0, x_0*x_1*x_2*y_0, x_0*x_2**_sage_const_2 *y_0, x_1**_sage_const_3 *y_0,x_1**_sage_const_2 *x_2*y_0, x_1*x_2**_sage_const_2 *y_0, x_2**_sage_const_3 *y_0]
P_2_mons = [x_0**_sage_const_6 *y_0**_sage_const_2 , x_0**_sage_const_5 *x_1*y_0**_sage_const_2 , x_0**_sage_const_5 *x_2*y_0**_sage_const_2 , x_0**_sage_const_4 *x_1**_sage_const_2 *y_0**_sage_const_2 , x_0**_sage_const_4 *x_1*x_2*y_0**_sage_const_2 , x_0**_sage_const_4 *x_2**_sage_const_2 *y_0**_sage_const_2 , x_0**_sage_const_3 *x_1**_sage_const_3 *y_0**_sage_const_2 , x_0**_sage_const_3 *x_1**_sage_const_2 *x_2*y_0**_sage_const_2 , x_0**_sage_const_3 *x_1*x_2**_sage_const_2 *y_0**_sage_const_2 , x_0**_sage_const_3 *x_2**_sage_const_3 *y_0**_sage_const_2 , x_0**_sage_const_2 *x_1**_sage_const_4 *y_0**_sage_const_2 ,x_0**_sage_const_2 *x_1**_sage_const_3 *x_2*y_0**_sage_const_2 , x_0**_sage_const_2 *x_1**_sage_const_2 *x_2**_sage_const_2 *y_0**_sage_const_2 , x_0**_sage_const_2 *x_1*x_2**_sage_const_3 *y_0**_sage_const_2 , x_0**_sage_const_2 *x_2**_sage_const_4 *y_0**_sage_const_2 , x_0*x_1**_sage_const_5 *y_0**_sage_const_2 ,x_0*x_1**_sage_const_4 *x_2*y_0**_sage_const_2 , x_0*x_1**_sage_const_3 *x_2**_sage_const_2 *y_0**_sage_const_2 , x_0*x_1**_sage_const_2 *x_2**_sage_const_3 *y_0**_sage_const_2 , x_0*x_1*x_2**_sage_const_4 *y_0**_sage_const_2 , x_0*x_2**_sage_const_5 *y_0**_sage_const_2 ,x_1**_sage_const_6 *y_0**_sage_const_2 , x_1**_sage_const_5 *x_2*y_0**_sage_const_2 , x_1**_sage_const_4 *x_2**_sage_const_2 *y_0**_sage_const_2 , x_1**_sage_const_3 *x_2**_sage_const_3 *y_0**_sage_const_2 , x_1**_sage_const_2 *x_2**_sage_const_4 *y_0**_sage_const_2 , x_1*x_2**_sage_const_5 *y_0**_sage_const_2 ,x_2**_sage_const_6 *y_0**_sage_const_2 ]
