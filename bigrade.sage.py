...
_sage_const_4 = Integer(4); _sage_const_2 = Integer(2); _sage_const_17 = Integer(17); _sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0)
import itertools
...
# f = random({0,2}, R)
# g = random({0,2},R)
# f = x_0^2 + x_1^2 + x_2^2 - x_1*x_2 + x_3^2
# g = x_0^2 + x_0*x_1 -x_2^2 + x_1^2-x_3^2
# F = y_0 * f + y_1 * g
# J = R/ideal jacobian F
# for p from 0 to 5 list hilbertFunction({p,0}, J)
# basis({0,0}, J)
...
f = x_0**_sage_const_2  + x_1**_sage_const_2  + x_2**_sage_const_2  - x_1*x_2 + x_3**_sage_const_2 
g = x_0**_sage_const_2  + x_0*x_1 -x_2**_sage_const_2  + x_1**_sage_const_2 -x_3**_sage_const_2 
...
P_1_mons = [x_0**_sage_const_2 *y_0, x_0**_sage_const_2 *y_1, x_0*x_1*y_0, x_0*x_1*y_1, x_0*x_2*y_0, x_0*x_2*y_1, x_0*x_3*y_0, x_0*x_3*y_1, x_1**_sage_const_2 *y_0, x_1**_sage_const_2 *y_1, x_1*x_2*y_0, x_1*x_2*y_1, x_1*x_3*y_0, x_1*x_3*y_1, x_2**_sage_const_2 *y_0, x_2**_sage_const_2 *y_1, x_2*x_3*y_0, x_2*x_3*y_1, x_3**_sage_const_2 *y_0, x_3**_sage_const_2 *y_1]
P_2_mons = [x_0**_sage_const_4 *y_0**_sage_const_2 , x_0**_sage_const_4 *y_0*y_1, x_0**_sage_const_4 *y_1**_sage_const_2 , x_0**_sage_const_3 *x_1*y_0**_sage_const_2 , x_0**_sage_const_3 *x_1*y_0*y_1, x_0**_sage_const_3 *x_1*y_1**_sage_const_2 ,x_0**_sage_const_3 *x_2*y_0**_sage_const_2 , x_0**_sage_const_3 *x_2*y_0*y_1, x_0**_sage_const_3 *x_2*y_1**_sage_const_2 , x_0**_sage_const_3 *x_3*y_0**_sage_const_2 , x_0**_sage_const_3 *x_3*y_0*y_1, x_0**_sage_const_3 *x_3*y_1**_sage_const_2 ,x_0**_sage_const_2 *x_1**_sage_const_2 *y_0**_sage_const_2 , x_0**_sage_const_2 *x_1**_sage_const_2 *y_0*y_1, x_0**_sage_const_2 *x_1**_sage_const_2 *y_1**_sage_const_2 , x_0**_sage_const_2 *x_1*x_2*y_0**_sage_const_2 , x_0**_sage_const_2 *x_1*x_2*y_0*y_1,x_0**_sage_const_2 *x_1*x_2*y_1**_sage_const_2 , x_0**_sage_const_2 *x_1*x_3*y_0**_sage_const_2 , x_0**_sage_const_2 *x_1*x_3*y_0*y_1, x_0**_sage_const_2 *x_1*x_3*y_1**_sage_const_2 , x_0**_sage_const_2 *x_2**_sage_const_2 *y_0**_sage_const_2 ,x_0**_sage_const_2 *x_2**_sage_const_2 *y_0*y_1, x_0**_sage_const_2 *x_2**_sage_const_2 *y_1**_sage_const_2 , x_0**_sage_const_2 *x_2*x_3*y_0**_sage_const_2 , x_0**_sage_const_2 *x_2*x_3*y_0*y_1, x_0**_sage_const_2 *x_2*x_3*y_1**_sage_const_2 ,x_0**_sage_const_2 *x_3**_sage_const_2 *y_0**_sage_const_2 , x_0**_sage_const_2 *x_3**_sage_const_2 *y_0*y_1, x_0**_sage_const_2 *x_3**_sage_const_2 *y_1**_sage_const_2 , x_0*x_1**_sage_const_3 *y_0**_sage_const_2 , x_0*x_1**_sage_const_3 *y_0*y_1, x_0*x_1**_sage_const_3 *y_1**_sage_const_2 ,x_0*x_1**_sage_const_2 *x_2*y_0**_sage_const_2 , x_0*x_1**_sage_const_2 *x_2*y_0*y_1, x_0*x_1**_sage_const_2 *x_2*y_1**_sage_const_2 , x_0*x_1**_sage_const_2 *x_3*y_0**_sage_const_2 , x_0*x_1**_sage_const_2 *x_3*y_0*y_1,x_0*x_1**_sage_const_2 *x_3*y_1**_sage_const_2 , x_0*x_1*x_2**_sage_const_2 *y_0**_sage_const_2 , x_0*x_1*x_2**_sage_const_2 *y_0*y_1, x_0*x_1*x_2**_sage_const_2 *y_1**_sage_const_2 , x_0*x_1*x_2*x_3*y_0**_sage_const_2 ,x_0*x_1*x_2*x_3*y_0*y_1, x_0*x_1*x_2*x_3*y_1**_sage_const_2 , x_0*x_1*x_3**_sage_const_2 *y_0**_sage_const_2 , x_0*x_1*x_3**_sage_const_2 *y_0*y_1, x_0*x_1*x_3**_sage_const_2 *y_1**_sage_const_2 ,x_0*x_2**_sage_const_3 *y_0**_sage_const_2 , x_0*x_2**_sage_const_3 *y_0*y_1, x_0*x_2**_sage_const_3 *y_1**_sage_const_2 , x_0*x_2**_sage_const_2 *x_3*y_0**_sage_const_2 , x_0*x_2**_sage_const_2 *x_3*y_0*y_1,x_0*x_2**_sage_const_2 *x_3*y_1**_sage_const_2 , x_0*x_2*x_3**_sage_const_2 *y_0**_sage_const_2 , x_0*x_2*x_3**_sage_const_2 *y_0*y_1, x_0*x_2*x_3**_sage_const_2 *y_1**_sage_const_2 , x_0*x_3**_sage_const_3 *y_0**_sage_const_2 ,x_0*x_3**_sage_const_3 *y_0*y_1, x_0*x_3**_sage_const_3 *y_1**_sage_const_2 , x_1**_sage_const_4 *y_0**_sage_const_2 , x_1**_sage_const_4 *y_0*y_1, x_1**_sage_const_4 *y_1**_sage_const_2 , x_1**_sage_const_3 *x_2*y_0**_sage_const_2 , x_1**_sage_const_3 *x_2*y_0*y_1,x_1**_sage_const_3 *x_2*y_1**_sage_const_2 , x_1**_sage_const_3 *x_3*y_0**_sage_const_2 , x_1**_sage_const_3 *x_3*y_0*y_1, x_1**_sage_const_3 *x_3*y_1**_sage_const_2 , x_1**_sage_const_2 *x_2**_sage_const_2 *y_0**_sage_const_2 , x_1**_sage_const_2 *x_2**_sage_const_2 *y_0*y_1,x_1**_sage_const_2 *x_2**_sage_const_2 *y_1**_sage_const_2 , x_1**_sage_const_2 *x_2*x_3*y_0**_sage_const_2 , x_1**_sage_const_2 *x_2*x_3*y_0*y_1, x_1**_sage_const_2 *x_2*x_3*y_1**_sage_const_2 , x_1**_sage_const_2 *x_3**_sage_const_2 *y_0**_sage_const_2 ,x_1**_sage_const_2 *x_3**_sage_const_2 *y_0*y_1, x_1**_sage_const_2 *x_3**_sage_const_2 *y_1**_sage_const_2 , x_1*x_2**_sage_const_3 *y_0**_sage_const_2 , x_1*x_2**_sage_const_3 *y_0*y_1, x_1*x_2**_sage_const_3 *y_1**_sage_const_2 , x_1*x_2**_sage_const_2 *x_3*y_0**_sage_const_2 ,x_1*x_2**_sage_const_2 *x_3*y_0*y_1, x_1*x_2**_sage_const_2 *x_3*y_1**_sage_const_2 , x_1*x_2*x_3**_sage_const_2 *y_0**_sage_const_2 , x_1*x_2*x_3**_sage_const_2 *y_0*y_1, x_1*x_2*x_3**_sage_const_2 *y_1**_sage_const_2 ,x_1*x_3**_sage_const_3 *y_0**_sage_const_2 , x_1*x_3**_sage_const_3 *y_0*y_1, x_1*x_3**_sage_const_3 *y_1**_sage_const_2 , x_2**_sage_const_4 *y_0**_sage_const_2 , x_2**_sage_const_4 *y_0*y_1, x_2**_sage_const_4 *y_1**_sage_const_2 , x_2**_sage_const_3 *x_3*y_0**_sage_const_2 ,x_2**_sage_const_3 *x_3*y_0*y_1, x_2**_sage_const_3 *x_3*y_1**_sage_const_2 , x_2**_sage_const_2 *x_3**_sage_const_2 *y_0**_sage_const_2 , x_2**_sage_const_2 *x_3**_sage_const_2 *y_0*y_1, x_2**_sage_const_2 *x_3**_sage_const_2 *y_1**_sage_const_2 , x_2*x_3**_sage_const_3 *y_0**_sage_const_2 ,x_2*x_3**_sage_const_3 *y_0*y_1, x_2*x_3**_sage_const_3 *y_1**_sage_const_2 , x_3**_sage_const_4 *y_0**_sage_const_2 , x_3**_sage_const_4 *y_0*y_1, x_3**_sage_const_4 *y_1**_sage_const_2 ]
...
def frobenius_on_cohom(i,prec = _sage_const_2 ):
    g = B[i]*prod(gens)
    g = frobenius(g,prec)
    return R(g *p**(n+num_poly -_sage_const_1 ) / prod(gens))


lift_dict = {}

def lift_poly(g):
    summer = (n+num_poly) * [_sage_const_0 ]
    for monomial in g.monomials():
...
def reduce_griffiths_dwork(u,g):
    ...
    while (u not in P_1_pts):
        ...
        k = best_k
        # todo: check this
        if pole_order(vector_to_monomial([u[i] - k*v[i] for i in range(n+num_poly)])) == _sage_const_0 :
