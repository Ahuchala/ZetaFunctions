...
B = [R(_sage_const_1 ), x_2**_sage_const_3 *y_0] # need to be careful to use a basis sage likes
# B = [R(1), x_3^2*y_1]
        ...
        if term not in QQ:  
            ...
            if not monomial in B:
                if not monomial in reduction_dict.keys():
                    ...
                    reduction_dict[monomial] = temp/max(_sage_const_1 ,pole_order(monomial)-_sage_const_1 ) + q
