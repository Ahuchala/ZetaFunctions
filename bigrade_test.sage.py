...
_sage_const_1 = Integer(1); _sage_const_31 = Integer(31); _sage_const_2 = Integer(2); _sage_const_5 = Integer(5); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_6 = Integer(6); _sage_const_0 = Integer(0)# maybe we require f to be nondegenerate too?
...
# p = Primes().next(2^13)
p = _sage_const_31 
prec = _sage_const_2 # todo: work this out
arithmetic_precision_increase = _sage_const_2  # todo: work this out too
...
f =  -_sage_const_5 *x_0**_sage_const_3 -x_0*x_1**_sage_const_2 +_sage_const_4 *x_0**_sage_const_2 *x_2+_sage_const_2 *x_0*x_1*x_2-_sage_const_3 *x_1**_sage_const_2 *x_2-_sage_const_2 *x_0*x_2**_sage_const_2 -_sage_const_6 *x_1*x_2**_sage_const_2 +_sage_const_5 *x_2**_sage_const_3 
...
def frobenius_on_cohom(i,prec = _sage_const_2 ):
    ...
    return multiplication_by_scalar(p**(n -_sage_const_1 ),divide_by_x0xn(Bi_times_prod_gens))
...
def reduce_griffiths_dwork(u,g):
    ...
    # todo: speed up!
    while(pole_order_vector(u))>max_cohomology_pole_order+_sage_const_1 :
