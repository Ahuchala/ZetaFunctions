...
_sage_const_1 = Integer(1); _sage_const_11 = Integer(11); _sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0)# maybe we require f to be nondegenerate too?
...
# p = Primes().next(2^13)
p = _sage_const_11 
prec = _sage_const_3 # todo: work this out
...
f = sum(gen**_sage_const_4  for gen in x_vars)
