...
_sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0)
import itertools
...
f = x_0**_sage_const_2 *x_1+x_1**_sage_const_3 +x_0*x_1*x_2+x_1*x_2**_sage_const_2 +x_2**_sage_const_3 
...
for i in range(len(B)):
    ...
    for j in range(len(B)):
        frob_matrix[i][j] = summer.monomial_coefficient(R(B[j])) * factorial(pole_order(B[j]) + num_poly-_sage_const_1 ) # !!?!?!?!?!/
