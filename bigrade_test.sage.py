...
_sage_const_4 = Integer(4); _sage_const_2 = Integer(2); _sage_const_7 = Integer(7); _sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0)
import itertools
...
for i in range(len(B)):
    ...
    for u,g in to_uvg(h):
        ...
        denom = factorial(pole_order(vector_to_monomial(u))-_sage_const_1 +n)
