...
_sage_const_2 = Integer(2); _sage_const_17 = Integer(17); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0)# maybe we require f to be nondegenerate too?
...
# p = Primes().next(2^13)
p = _sage_const_17 
prec = _sage_const_1 # todo: work this out
arithmetic_precision_increase = _sage_const_3  # todo: work this out too
...
def compute_Ruv(v):
    if USE_RATIONAL_ARITHMETIC:
        ...
        Ruv_u_mat = [list(matrix(arithmetic_ring,size_pn,size_pn)) for i in range(n+num_poly+_sage_const_1 )]
    ...
    if USE_RATIONAL_ARITHMETIC:
        ...
        Ruv_u_dict[tuple(v)] = tuple(matrix(arithmetic_ring,Ruv_u_mat[i]) for i in range(n+num_poly+_sage_const_1 ))
    return
...
for i,B_i in enumerate(B):
    ...
    for j,B_j in enumerate(B):
        frob_matrix[i][j] = summer.monomial_coefficient(B_j) * factorial(pole_order(B_j)+num_poly-_sage_const_1 ) #% p^prec
