...
_sage_const_1 = Integer(1); _sage_const_389 = Integer(389); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0)# maybe we require f to be nondegenerate too?
