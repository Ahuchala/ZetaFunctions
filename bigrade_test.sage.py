...
_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_12 = Integer(12); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0)# import itertools
# import numpy as np
...
p = Primes().next(_sage_const_2 **_sage_const_12 )
# p = 10193
prec = _sage_const_1 
arithmetic_precision_increase = _sage_const_3 
