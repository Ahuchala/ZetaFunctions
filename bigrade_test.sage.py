...
_sage_const_1 = Integer(1); _sage_const_7 = Integer(7); _sage_const_2 = Integer(2); _sage_const_6 = Integer(6); _sage_const_0 = Integer(0)# import itertools
# import numpy as np
...
f = sum([gen**_sage_const_6  for gen in x_vars])
