...
_sage_const_2 = Integer(2); _sage_const_7 = Integer(7); _sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0)# maybe we require f to be nondegenerate too?
...
g = sum(gen**_sage_const_2  for gen in x_vars)
