...
_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_13 = Integer(13); _sage_const_3 = Integer(3); _sage_const_0 = Integer(0)# import itertools
# import numpy as np
...
p = Primes().next(_sage_const_2 **_sage_const_13 )
# p = 5
...
# for _ in t:
#     if _ != "":
#         eval("reduction_basis.append(R(" + _ +"))")
# reduction_basis = [monomial_to_vector(mon) for mon in reduction_basis]
