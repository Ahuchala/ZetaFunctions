...
# This file was *autogenerated* from the file complete_intersection_zeta.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_13 = Integer(13); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_22 = Integer(22); _sage_const_46 = Integer(46); _sage_const_12 = Integer(12); _sage_const_35 = Integer(35); _sage_const_34 = Integer(34); _sage_const_36 = Integer(36); _sage_const_43 = Integer(43); _sage_const_16 = Integer(16); _sage_const_38 = Integer(38); _sage_const_23 = Integer(23); _sage_const_37 = Integer(37); _sage_const_19 = Integer(19); _sage_const_49 = Integer(49); _sage_const_30 = Integer(30); _sage_const_40 = Integer(40); _sage_const_20 = Integer(20); _sage_const_17 = Integer(17); _sage_const_15 = Integer(15); _sage_const_33 = Integer(33); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0)
USE_CYTHON = False
...
R = QQ['x_0, x_1, x_2, x_3, x_4, y_1, y_2']; (x_0, x_1, x_2, x_3, x_4, y_1, y_2,) = R._first_ngens(7)
...
f = x_0 *x_2 + x_1* x_3 + x_4**_sage_const_2  


g = -x_0**_sage_const_3 -_sage_const_22 *x_0**_sage_const_2 *x_1+_sage_const_46 *x_0*x_1**_sage_const_2 +_sage_const_12 *x_1**_sage_const_3 -_sage_const_35 *x_0**_sage_const_2 *x_2-_sage_const_34 *x_0*x_1*x_2+_sage_const_36 *x_1**_sage_const_2 *x_2-_sage_const_43 *x_0*x_2**_sage_const_2 +_sage_const_16 *x_1*x_2**_sage_const_2 -_sage_const_34 *x_2**_sage_const_3 +_sage_const_38 *x_0**_sage_const_2 *x_3+_sage_const_23 *x_0*x_1*x_3-_sage_const_22 *x_1**_sage_const_2 *x_3-_sage_const_43 *x_0*x_2*x_3+_sage_const_37 *x_1*x_2*x_3+_sage_const_46 *x_2**_sage_const_2 *x_3-_sage_const_2 *x_0*x_3**_sage_const_2 -_sage_const_19 *x_1*x_3**_sage_const_2 +_sage_const_49 *x_2*x_3**_sage_const_2 -_sage_const_30 *x_0**_sage_const_2 *x_4-_sage_const_12 *x_0*x_1*x_4-_sage_const_40 *x_1**_sage_const_2 *x_4+_sage_const_20 *x_0*x_2*x_4+_sage_const_17 *x_1*x_2*x_4-_sage_const_35 *x_2**_sage_const_2 *x_4-_sage_const_15 *x_0*x_3*x_4-_sage_const_49 *x_1*x_3*x_4-_sage_const_38 *x_2*x_3*x_4-_sage_const_2 *x_0*x_4**_sage_const_2 -_sage_const_33 *x_1*x_4**_sage_const_2 -_sage_const_4 *x_2*x_4**_sage_const_2 
...
#   y_i contribute (sum(e[n:],sum([-poly_list[i].degree() for i in range(num_poly)] ))
    return [sum(e[n+_sage_const_1 :]),  sum(e[:n+_sage_const_1 ]) +     sum([e[i+n+_sage_const_1 ]*-d[i] for i in range(num_poly)] )]
        ...
        if not monomial in lift_dict.keys():
            ...
            for i in range(n+num_poly+_sage_const_1 ):
                ...
                for _ in term_i.keys():
                    term_i[_] = (term_i[_]) % p**(_sage_const_2 +prec) # this converts to ZZ/p^prec
                term[i] = R(term_i)
