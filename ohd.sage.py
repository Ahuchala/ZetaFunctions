...
_sage_const_7 = Integer(7); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1)
...
f = x**_sage_const_4  + y**_sage_const_4  + z**_sage_const_4 -x*y*z**_sage_const_2 +_sage_const_4 *x**_sage_const_2 *z**_sage_const_2 
...
if use_macaulay:
    print('computing lifts of degree ' + str((n-_sage_const_1 )*d-(n-_sage_const_1 )+d) + ' using macaulay')
    s = ''
    ...
    if n == _sage_const_3 :
        ...
        toString basis(''' + str((n-_sage_const_1 )*d-(n-_sage_const_1 )+d) + ''',R), toString (basis(''' + str((n-_sage_const_1 )*d-(n-_sage_const_1 )+d) + ''',R) // M)
        ''')
    ...
    print('computing lifts of degree ' + str((n-_sage_const_1 )*d-(n-_sage_const_1 )+d) + ' using sage')
    for part in Partitions((n-_sage_const_1 )*d-(n-_sage_const_1 )+d, max_length=n):
    #       pad with zeros
        part += [_sage_const_0 ] * (n - len(part))
        ...
        if not already_divisible:
            ...
            for i in range(n):
                while vector[i] > _sage_const_0 :
                    ...
                    if sum(g_vec) == (n-_sage_const_1 ) * fdegree - (n -_sage_const_1 ):
                        u = vector
                        vector = n * [_sage_const_0 ]
