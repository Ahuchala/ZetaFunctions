...
_sage_const_7 = Integer(7); _sage_const_4 = Integer(4); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3)
...
weights = [_sage_const_1 ,_sage_const_1 ,_sage_const_1 ,_sage_const_1 ]
# weights = [1,1,1]
# weights = [1,3,1]
...
if use_macaulay:
    ...
    print('computing lifts of degree ' + str((n-_sage_const_1 )*d-sum(weights)+_sage_const_1 +d) + ' using sage')
