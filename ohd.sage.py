...
_sage_const_17 = Integer(17); _sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0)
...
f = y**_sage_const_2  -(-_sage_const_2 *x**_sage_const_6 -x**_sage_const_5 *z+_sage_const_3 *x**_sage_const_4 *z**_sage_const_2 +x**_sage_const_3 *z**_sage_const_3 -_sage_const_2 *x**_sage_const_2 *z**_sage_const_4 +x*z**_sage_const_5 +_sage_const_3 *z**_sage_const_6 )
