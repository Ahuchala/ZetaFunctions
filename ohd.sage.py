...
_sage_const_53 = Integer(53); _sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2)
...
f = x**_sage_const_4  + y**_sage_const_4  + z**_sage_const_4  + w**_sage_const_4  - w * x * y *z
...
def reduce_griffiths_dwork(u,g):
    ...
    while (u not in P1_pts):
        ...
        v = best_v
        k = best_k
        if degree_vector([u[i] - k*v[i] for i in range(n)]) == _sage_const_0 :
