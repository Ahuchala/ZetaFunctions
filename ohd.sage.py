...
_sage_const_7 = Integer(7); _sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_5 = Integer(5); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2)
...
f = x**_sage_const_5  + y**_sage_const_5  + z**_sage_const_5  - x*y*z**_sage_const_3 
# f = x^4 + y^4 + z^4-x*y*z^2+4*x^2*z^2
