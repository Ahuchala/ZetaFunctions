...
_sage_const_7 = Integer(7); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_5 = Integer(5); _sage_const_0 = Integer(0)
            ...
            for v in Pn_minus_1_pts:
                ...
                for mon in mon_keys:
                    if all([mon[i]>=v[i] for i in range(n)]):
                        ...
                        div_count = len([_sage_const_0  for a in mon_keys if all([a[i]>=u[i] for i in range(n)])])
