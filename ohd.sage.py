...
_sage_const_13 = Integer(13); _sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_6 = Integer(6); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4)
...
# weights = [1,1,1,1]
# weights = [1,1,1]
weights = [_sage_const_1 ,_sage_const_3 ,_sage_const_1 ]
...
#     print(gi)
    ...
    for i in range(n):
        while u[i] > _sage_const_0 :
            ...
            # print(v)
            if degree_vector(v)==_sage_const_1 :
            # if sum(v) == fdegree:
                return (u,v,h/m)
...
for i in range(len(B)):
    ...
    for u,v,g in to_uvg(h):
        while degree_vector(u)>_sage_const_1 :
        # while sum(u) > fdegree:
            u,v,g = Ruv(u,v,g)
