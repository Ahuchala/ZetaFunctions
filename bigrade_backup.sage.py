...
_sage_const_2 = Integer(2); _sage_const_17 = Integer(17); _sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_4 = Integer(4); _sage_const_0 = Integer(0)# import itertools
# import numpy as np
...
# g = x_0 * (sum(_^2 for _ in x_vars)) + x_1*(2*x_0^2-sum(_^2 for _ in x_vars))
