...
_sage_const_7 = Integer(7); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4)
...
# weight = [1,1,1,1]
weight = [_sage_const_1 ,_sage_const_1 ,_sage_const_3 ,_sage_const_1 ]
# weight = [1,3,1]
# weight = [1,1,1]
...
f = y**_sage_const_2  - x*w*z*(x+w+z)*(x+_sage_const_2 *w+z)*(_sage_const_3 *x+_sage_const_2 *w-z)
# f =x^6 - z^2 + y^6 + w^6
# f = w^6 - x^6 - y^6 - z^2
# f = x^6 - y^2 + z^6
n = len(R.gens())
